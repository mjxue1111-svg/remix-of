...
function FormStep({
  ...
  // Add mode fields — Section 2: contact info
  const [contactName, setContactName] = useState(defaultContactName);
  const [contactPhone, setContactPhone] = useState("");
  const [contactEmail, setContactEmail] = useState("");

  // Add mode fields — Section 3: materials
  ...
  const isFormValid =
    mode === "bind"
      ...
      : addSubject.trim() !== "" && contactName.trim() !== "" && contactPhone.trim() !== "" && confirmed;
        ...
        <div className="flex items-start justify-between">
          <div className="space-y-1">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              {mode === "add"
                ? "如您还没有可用的星图账户，请提供账户主体、联系人信息及账户证明材料，米播将为您新建账户。"
      ...
      <div className="flex-1 overflow-y-auto px-8 py-6"><div className="space-y-6">
        {mode === "bind" ? (
          ...
          <>
            ...
            {/* ══════════════════════════════════════════════════
                Add mode Section 2: Contact Info
                ══════════════════════════════════════════════════ */}
            <section className="space-y-3">
              <div className="flex items-center gap-2">
