...
const allTasks: Task[] = [
  ...
  { id: "RC-2026-07021", account: "云岚内容增长", accountId: "ST-10086103", subject: "上海云岚科技有限公司", accountType: "运营账户", amount: "¥60,000.00", payableAmount: "¥58,800.00", discount: "98 折", node: "transfer_error", rechargeType: "regular", step: 3, totalSteps: 4, time: "2026-07-09 10:20", purpose: "达人采买", orderCompleted: false },
  // Draft — regular
  ...
  { id: "RC-2026-07005", account: "云岚达人合作", accountId: "ST-10086105", subject: "上海云岚科技有限公司", accountType: "品牌账户", amount: "¥40,000.00", payableAmount: "¥39,200.00", discount: "98 折", node: "sp_payment_pending", rechargeType: "special", step: 5, totalSteps: 5, time: "2026-07-15 11:00", purpose: "广告投放", orderCompleted: false, specialReason: "达人排期已锁定，账户余额不足需先行充值保障投放", specialExpectedPayTime: "2026-07-20 18:00", businessContact: "李商务" },
  { id: "RC-2026-07004", account: "云岚新品推广", accountId: "ST-10086104", subject: "上海云岚科技有限公司", accountType: "投放账户", amount: "¥80,000.00", payableAmount: "¥78,400.00", discount: "98 折", node: "sp_payment_uploaded", rechargeType: "special", step: 5, totalSteps: 5, time: "2026-07-14 15:00", purpose: "达人采买", paymentReceipt: "特批付款回单_20260714.pdf", financeConfirmed: false, orderCompleted: false, specialReason: "新品上市活动临时追加预算，需提前充值保障投放节奏", specialExpectedPayTime: "2026-07-19 12:00", businessContact: "王商务" },
  { id: "RC-2026-07003", account: "云岚内容增长", accountId: "ST-10086103", subject: "上海云岚科技有限公司", accountType: "运营账户", amount: "¥120,000.00", payableAmount: "¥117,600.00", discount: "98 折", node: "sp_evaluating", rechargeType: "special", step: 2, totalSteps: 5, time: "2026-07-14 10:30", purpose: "助推投流", orderCompleted: false, specialReason: "内容助推活动即将开始，账期审批中需先行充值", specialExpectedPayTime: "2026-07-21 10:00", businessContact: "张商务" },
  { id: "RC-2026-07002", account: "云岚效果投放", accountId: "ST-10086102", subject: "上海云岚科技有限公司", accountType: "投放账户", amount: "¥60,000.00", payableAmount: "¥58,800.00", discount: "98 折", node: "sp_payment_rejected", rechargeType: "special", step: 5, totalSteps: 5, time: "2026-07-13 14:00", purpose: "广告投放", paymentReceipt: "特批回单_20260713.pdf", paymentStatus: "error", financeConfirmed: false, orderCompleted: false, errorReason: "付款主体与申请主体不一致", errorDescription: "请确认付款账户与申请客户主体一致后重新提交，或补充代付说明。", specialReason: "客户投放排期紧急，账户余额不足，需先充值保证投放", specialExpectedPayTime: "2026-07-18", specialApprovedTime: "2026-07-12 15:00", specialCompletedTime: "2026-07-12 17:00", businessContact: "陈商务" },
  { id: "RC-2026-07001", account: "云岚品牌中心", accountId: "ST-10086101", subject: "上海云岚科技有限公司", accountType: "主账户", amount: "¥90,000.00", payableAmount: "¥88,200.00", discount: "98 折", node: "sp_approved", rechargeType: "special", step: 3, totalSteps: 5, time: "2026-07-12 09:00", purpose: "达人采买", orderCompleted: false, specialReason: "品牌大促预热期需提前锁定资源，申请先行充值", specialExpectedPayTime: "2026-07-22 16:00", businessContact: "李商务" },
  // Draft — special
...
function RechargePage() {
  ...
  const buildDetailTaskInfo = (t: Task | null): DetailTaskInfo | null => {
    ...
    return { id: t.id, account: t.account, accountId: t.accountId, amount: t.amount, payableAmount: t.payableAmount, discount: t.discount, node: t.node, nodeLabel: node?.label ?? "", nodeClassName: node?.className ?? "", handler: "", statusDescription: "", time: t.time, rechargeType: t.rechargeType, step: t.step, totalSteps: t.totalSteps, isDraft: t.isDraft, paymentStatus: t.paymentStatus, paymentAmount: t.paymentAmount, paymentTime: t.paymentTime, paymentAccountName: t.paymentAccountName, paymentBank: t.paymentBank, paymentReceipt: t.paymentReceipt, financeConfirmed: t.financeConfirmed, financeConfirmedTime: (t as any).financeConfirmedTime, errorReason: t.errorReason, errorDescription: t.errorDescription, specialReason: t.specialReason, promisedPayTime: t.specialExpectedPayTime, businessContact: t.businessContact };
  };
